...
object MenuModule {
    ...
    fun provides_menu() : ArrayList<Food>{
        ...
        menu.add(Food(1,"https://i.pinimg.com/600x315/f6/d4/ee/f6d4ee6aa3264872e262435c898fe2fe.jpg","Kaimatis (20 pcs) SugarCoated", 350, 20,1, BREAKFAST,"Kaimatis coated with sugar known as kaimati or kalimati. "))
        ...
        menu.add(Food(14,"https://www.tablespoon.com/-/media/Images/Articles/Content/meals/sides/how-to-cook-mixed-vegetaqbles/how-to-cook-mixed-vegetables.jpg","Mixed Veggies ", 350, 1, 1,SIDES))
